...
1. **Idle** - Waiting for player to press SPACE
2. **Running** - Active gameplay
3. **Game Over** - Bird hit wall or went out of bounds
4. **Restart** - Ready to press SPACE again
...
Created by [theanuragkushwaha](https://github.com/theanuragkushwaha)
